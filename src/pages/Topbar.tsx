    ...
    return (
        <div className="bg-white px-6 py-4 flex items-center justify-between border-b border-gray-200">
            ...
            <div className="flex items-center space-x-4">
                ...
                <button
                    className="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center border-2 border-transparent hover:border-blue-500 transition"
                    title="User Details"
                    onClick={() => navigate("/user")}
                >
                    {/* Optionally use avatar image if available */}
                    {/* {currentUser?.name ? (
                        <img
